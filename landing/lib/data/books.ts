...
export const BOOKS: (Omit<Book, "author" | "description"> & {
...
})[] = [
  {
    ...
    urls: [
      ...
      {
        url: "https://doi.org/10.1163/9789004750951",
        ctaKey: "libros.ctaDOI",
      },
      {
        url: 'https://books.google.com/books/about/Vernacular_Documents_of_Medieval_Sardini.html?id=fa3VEQAAQBAJ',
        ctaKey: "libros.ctaGoogleBooks",
      }
    ],
  },
  {
    ...
    urls: [
      ...
      {
        url: "https://doi.org/10.1163/9789004467545",
        ctaKey: "libros.ctaDOI",
      },
      {
        url: "https://www.amazon.com.mx/Making-Medieval-Sardinia-128/dp/9004464484",
        ctaKey: "libros.ctaAmazonMX",
      }
    ],
  },
  {
    ...
    urls: [
      ...
      {
        url: "https://doi.org/10.5040/9781350138322",
        ctaKey: "libros.ctaDOI",
      },
      {
        url: "https://books.google.com/books/about/County_and_Nobility_in_Norman_Italy.html?id=Ujj1DwAAQBAJ",
        ctaKey: "libros.ctaGoogleBooks",
      },
      {
        url: "https://www.amazon.com.mx/County-Nobility-Norman-Italy-Aristocratic-ebook/dp/B08F77D93L",
        ctaKey: "libros.ctaAmazonMX",
      }
    ],
  },
